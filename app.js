...
(function () {
  ...
  var I18N = {
    ...
    en: {
      ...
      'contact.phonePlaceholder': '+49 …',
      'contact.phoneHint': 'Appears as a call button when somebody asks about an item. Leave it empty if you would rather be contacted in writing.',
      ...
      'circle.fPreview': 'lives in that person\u2019s browser, not reachable here',
      ...
      'add.s3': '{name} is part of the range from now on.',
      ...
      'buch.title': 'Book of rounds',
      'buch.open': 'Open the book of rounds, level {name}',
